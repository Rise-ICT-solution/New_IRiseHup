...
function Footer (){
    return <div className="w-full flex flex-col h-[650px] items-center justify-center ">
            <div className="w-full h-[450px] flex  border-b-[1.5px] pb-[30px] border-b-gray-300 mt-20 px-[100px] ">
                {/* Left */}
